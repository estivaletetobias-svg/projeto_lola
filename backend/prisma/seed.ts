...
async function main() {
    ...
    // 2. Criar Catálogo de Cargos (Construção + Tech para demonstração versátil)
    const constructionJobs = [
        // ... (existing construction jobs if any, but let's just create a unified list)
        ...
        // --- Cluster Tecnologia & Produto (High Value for Investors) ---
